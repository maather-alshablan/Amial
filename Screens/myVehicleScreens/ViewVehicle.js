...
this.state = {
VehicleOwner: false,
vehicleID: props?.route?.params?.vehicleID ? props?.route?.params?.vehicleID : 'l1dxAcoKpXfqwG95388A',
ownerID: '',
vehicleDetails: {},
availability: [],
features: [],
...
return (<TouchableOpacity style={{ 5 , padding: 10, borderColor: 'black', borderRadius: 2, borderWidth: 1, color: '#5dbcd2', }} >
...
<View style={{ height: 200, width: '100%', backgroundColor: 'transparent' }}>
<Image source={{ uri: this.state.vehicleDetails.images ? this.state.vehicleDetails.images : this.state.vehicleDetails.image }}
