...
export default class manageVehicle extends Component {
  ...
  renderAddCar = () => {
    return (<TouchableOpacity
      ...
      <Text style={{ fontSize: 14, color: '#000', fontFamily: 'Tajawal_400Regular', }}>إضافة سيارة</Text>
    </TouchableOpacity>)
  }
  render() {
    return (
        ...
        <ScrollView contentContainerStyle={{ padding: 24 }}>
          {this.state.cars.length == 0 ? this.renderAddCar() : this.state.cars.map(car => {
            ...
            >
              ...
              <View style={{ flexDirection: 'row', flex: 1, borderTopColor: '#000', borderTopWidth: 1, fontFamily: 'Tajawal_400Regular', }}>
