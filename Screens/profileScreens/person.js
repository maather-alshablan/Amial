...
import { Octicons, FontAwesome5 } from '../../Constants/icons';
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: 'column', alignSelf: 'center', alignItems: 'center', }}>
          ...
          <Text style={{ ...styles.title, marginRight: 8, alignSelf:'center' }}>رصيدك الحالي  {this.state.totalBalance} ريال</Text>
